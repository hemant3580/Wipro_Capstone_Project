...
public class EcommerceAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		loginStep(driver, "standard_user", "secret_sauce", "Logged in Successfully");
		addToCart(driver, "hemant", "bhase", "411020", "added to cart hemant bhase 411020");
		logoutPage(driver, "logged out");
	}
}
